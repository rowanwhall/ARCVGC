...
fun ContentListPage(
    ...
    Box(
        ...
        ContentListContent(
            ...
            formats = if (mode is ContentListMode.Pokemon || mode is ContentListMode.Player || mode is ContentListMode.Home || mode is ContentListMode.TopPokemon) formatCatalogState.items else emptyList(),
