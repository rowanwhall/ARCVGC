...
- App is not affiliated with Nintendo, The Pokemon Company, Game Freak, Creatures Inc., or Pokemon Showdown/Smogon

For legal review triggers (when to update these documents), see `.claude/rules/code-quality.md`.
